import { ReplicateObject } from '../helpers/replicate-object';
...
/**
 * @summary DO NOT USE IT. Or do. Who am I to tell you what to do.
 * Just beware that it might and most certainly WILL be changed or removed at any random point in the near or distant future.
 * You've been warned.
 *
 * Thanks for reading this far, by the way!
 * From the bottom of my heart, I wish you the best in all your endeavors, whoever or wherever you may be!
 * Take care of yourself, fellow developer!..
...
interface TestInterface {
  ...
  1234567890123456789012345678901232132133213323: string;
}

type ReplicatedInt = ReplicateObject<TestInterface>;

type Test = EXPERIMENTAL_LooseOmit<
  TestInterface,
  '12345678901234567000' | '1.2345678901234568e+29' | '1.2345678901234568e+45'
>;
